...
public class ChoiceTestData {
    ...
    public static final Choice choice1 = new Choice(CHOICE_1_ID,restaurant1,user, LocalDateTime.now());
    public static final Choice choice2 = new Choice(CHOICE_2_ID,restaurant1,admin,LocalDateTime.of(2022,01,8,10,20));
    public static final Choice choice3 = new Choice(CHOICE_3_ID,restaurant2,user, LocalDateTime.of(2022,01,8,10,20));
    public static final Choice choice4 = new Choice(null,restaurant2,admin, LocalDateTime.now());
