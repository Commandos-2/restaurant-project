...
public class UserTestData {
    ...
    public static final User user = new User(USER_ID, "User", "password", "user@yandex.ru", Role.USER, new Date(),LocalDateTime.now());
    public static final User admin = new User(ADMIN_ID, "Admin", "admin", "admin@gmail.com", Role.ADMIN,new Date(),LocalDateTime.of(2022, 01, 8, 10, 20));
